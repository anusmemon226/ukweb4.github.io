...
<body>
   ...
   <?php include('components/header.php')?>
    ...
    <div class="welcome-area" id="welcome">
        <!-- ***** Header Text Start ***** -->
      <?php include('components/front_form.php')?>
        <div class="header-text">
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-6 col-md-6 col-sm-12 col-xs-12"
                        data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                        <h1>Are you <strong>looking for Assistance </strong> with your <strong>Dissertation</strong>?
                        </h1>
                        <p>We help Ensure your dream grades with the most reputable Dissertationnow.co.uk services here
                            online. </p>
                        <a href="#about" class="main-button-slider">REGISTER NOW</a>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"
                        data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                        <img src="assets/images/slider-icon.png" class="hero_img rounded img-fluid d-block mx-auto"
    ...
    <div class="container service_sec">
        <div class="row">
            <div class="col-md-12 serve_header">
                <h2>Finest Services We Provide To Make Your Academic Year Easier.</h2>
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dignissimos distinctio, iusto porro
                    vero, enim non dicta tenetur alias repellendus fugiat numquam id impedit. Rerum assumenda amet
                    officiis iure sunt? Porro.</p>
                <h1>Our Services</h1>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="serviceBox green">
                    ...
                    <h3 class="title">Dissertation</h3>
                    <p class="description">Lorem ipsum dolor sit amet conse ctetur adipisicing elit. Qui quaerat fugit
                        quas veniam perferendis repudiandae sequi, dolore quisquam illum.</p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="left-heading">
                        <h2>Top Notch Editing Service In Britain</h2>
                        <p>Proin justo sapien, posuere suscipit tortor in, fermentum mattis elit. Aenean in feugiat
                            purus.
                        </p>
                        <h1>About Us</h1>
                    </div>
                ...
                <div class="left-text col-lg-5 col-md-12 col-sm-12 mobile-bottom-fix">
                    <ul>
                        <li>
                            ...
                            <div class="text">
                                <h6>How Website Assures Quality?</h6>
    ...
    <section class="section" id="services">
        <div class="container">
            <div class="row">
                <div class="col-md-12 serve_header">
                    <h2 style="color: #ffb027;">Our Experts Provide You The Best Quality In Your</h2>
                    <p class="text-light pt-2">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dignissimos
                        distinctio, iusto porro
                        vero, enim non dicta tenetur alias repellendus fugiat numquam id impedit. Rerum assumenda amet
                        officiis iure sunt? Porro.</p>
                    <h1>Ordered Service Which Includes</h1>
                </div>
            </div>
            <div class="row">
                <div class="owl-carousel owl-theme">
                    ...
                    <div class="item service-item">
                        ...
                        <h5 class="service-title">Eight Title Box</h5>
                        <p>Sed a consequat velit. Morbi lectus sapien, vestibulum et sapien sit amet, ultrices malesuada
                            odio. Donec non quam.</p>
                        <a href="#" class="main-button">Read More</a>
                    </div>
    ...
    <div class="container demo">
        <div class="row">
            <div class="col-md-12 serve_header">
                <h2 style="color: #00a6d1;">Our Team Of Experts Helps You In Every Way!</h2>
                <p class="pt-2">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dignissimos
                    distinctio, iusto porro
                    vero, enim non dicta tenetur alias repellendus fugiat numquam id impedit. Rerum assumenda amet
                    officiis iure sunt? Porro.</p>
                <h1>Our Experts</h1>
                ...
                <div class="our-team">
                    <div class="pic">
                        <div class="layer-1">
                            <div class="layer-2">
                                <div class="layer-3">
                                    <img src="https://www.pinkvilla.com/files/styles/amp_metadata_content_image/public/money-heist-season-5-professor.jpg"
                                        alt="">
                                    <div class="social">
                        ...
                        <div class="team-info">
                            <h1 class="title">Williamson</h1>
                            <span class="post">Web Developer</span>
                        </div>
                    </div>
                    <p class="description">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed accumsan sagittis nunc ac tempus.
                        Curabitur.
                    </p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="left-text col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="accordion-text">
                        ...
                        <span>Email: <a href="#" style="color: #00a6d1;">email@company.com</a><br></span>
 ...
 <?php include('components/quote.php')?>
    ...
    <!-- Testimonial  -->
    <section class="section" style="padding: 8em 0 6em 0;">
        <div class="container">
            <div class="row">
                <div class="col-md-12 serve_header">
                    <h2 style="color: #00a6d1;">What Students Say About Us</h2>
                    <p class="pt-2">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dignissimos
                        distinctio, iusto porro
                        vero, enim non dicta tenetur alias repellendus fugiat numquam id impedit. Rerum assumenda amet
                        officiis iure sunt? Porro.</p>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h5 class="text-dark">Thiird slide label</h5>
                            <p>Some representative placeholder content for the first slide.</p>
                        </div>
                    </div>
                    <div class="carousel-item">
    ...
    <!-- banner section  -->
    <div class="container-fluid" style="background-color: #ffb027;">
        <div class="container py-5">
            <div class="row">
                <div class="col-12">
                    <div class="row">
                        <div class="col-lg-7 col-md-12 col-sm-12">
                            <h2 class=" text-light">Get In Touch With ABC Website</h2>
                            <p class="text-light">We have professors, professional editors, expert writers & QA
                                professionals to check and edit your Dissertations. Don’t’ hesitate to get in touch,
                                it’s safe and easy.</p>
                        </div>
                        <div
                            class="banner_btn col-lg-5 col-md-12 col-sm-12 d-flex align-items-center justify-content-center flex-wrap">
                            <a href="" class="p-2"><button class="main-button"><i class="fa fa-whatsapp" style="font-size: 20px;"></i> Whatsapp</button></a>
                            <a href="" class="p-2"><button class="main-button"><i class="fa fa-comment-o" style="font-size: 20px;"></i> Live Chat</button></a>
                        </div>
                    </div>
                </div>
            </div>
